...
from layout.components import external_stylesheets, external_scripts, header, footer, home_layout
...
infomodal = dbc.Modal(
    [
        ...
        dbc.ModalBody(
            [
                html.Div(
                    "This dashboard is a part of an engineering thesis project, which implements a Python package developed for calculating TOPSIS rankings, visualizations in WMSD-space and performing improvement actions."
                ),
                html.Div("Authors: Adam Ciesiółka, Bogna Kilanowska, Maciej Woś"),
                html.Div("Useful links:"),
                html.Div(" "),
                html.A(
                    "Github repository of the Python package",
                    href="https://github.com/dabrze/topsis-msd-improvement-actions",
                ),
                html.Div(" "),
                html.A(
                    "Github repository of this Dashboard",
                    href="https://github.com/MaciejWos01/WMSDIA-Dashboard",
                ),
            ]
        ),
    ],
                            ...
                            html.Div(
                                [
                                    html.Div(
                                        [
                                            html.Div(
                                                "On this page you can view your dataset and set the title for your project",
                                                className="info",
                                            ),
                                        ],
                                        className="info-container",
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.Div(
                                                id="wizard-data-output-parsed-data-after"
                                            ),
                                        ],
                                        id="data-content",
                                    ),
